...
data.01r<- data.01r%>%
  mutate(county_regions = case_when(
    ...
    county %in% c("Collin","Dallas","Denton","Ellis","Parker","Tarrant") ~ "Metroplex Region",
    ...
    county %in% c("Bell","Brazos","Grimes","McLennan") ~ "Central Region",
    county %in% c("Bastrop","Caldwell","Travis","Williamson") ~ "Capital Region",
    county %in% c("Bexar","Calhoun","Comal","Guadalupe","Kerr","Victoria","Wilson") ~ "Alamo Region",
    county %in% c("Cameron","Hidalgo","Jimwells","Kleberg","Nueces","San Patricio","Starr","Val Verde","Webb","Willacy","Zapata") ~ "Northwest Region"))
